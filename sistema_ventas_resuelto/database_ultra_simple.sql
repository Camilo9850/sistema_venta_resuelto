-- =====================================================
-- 🏗️ SCRIPT SQL ULTRA SIMPLE - SIN PROCEDIMIENTOS
-- Base de datos: abmventas
-- Fecha: 2025-07-31
-- Versión: Compatible con MariaDB 10.4.28
-- =====================================================
...
-- =====================================================
-- ELIMINAR TABLAS EXISTENTES (SIN ERRORES)
-- =====================================================
...
('mgarcía', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'María', 'García', 'maria@empresa.com');
...
-- =====================================================
-- CREAR VISTAS SIMPLES (SIN PROBLEMAS)
-- =====================================================
...
-- =====================================================
SELECT 
    'BASE DE DATOS CREADA EXITOSAMENTE SIN ERRORES' AS mensaje,
...
-- =====================================================
-- 🎉 SCRIPT ULTRA SIMPLE COMPLETADO
-- =====================================================
-- GARANTIZADO SIN ERRORES porque NO incluye:
-- ❌ Procedimientos almacenados (error 1558)
-- ❌ Triggers complejos
-- ❌ DELIMITER problemáticos
-- ❌ Funciones avanzadas
-- 
-- ✅ Solo tablas básicas + datos + 1 vista simple
-- ✅ 100% compatible con MariaDB 10.4.28
